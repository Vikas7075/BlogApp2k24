    ...
    return (
        <div>
            <div className=' px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start'>
                ...
                <div className=' md:sticky md:top-16 flex items-center flex-col space-y-4 md:w-[30%] w-full md:items-end'>
                    <div className='flex flex-col space-y-4'>
                        ...
                        <div className=' flex items-center space-x-4 mt-8'>
                            <button className=' text-white font-semibold bg-black px-4 py-2 hover:text-black hover:bg-gray-400'>Upadate</button>
